...
const CopyButton: React.FC<{ content: string; buttonId: string; copiedButton: string | null; onClick: () => void; }> = ({ content, buttonId, copiedButton, onClick }) => {
            ...
            <div className="max-w-6xl mx-auto bg-white p-8 sm:p-10 rounded-lg shadow-lg">
                ...
                <div className="mb-8">
                    ...
                    <div className="relative">
                        ...
                        <CopyButton content={JSON.stringify(fullJsonStructure, null, 2)} buttonId="full-json" copiedButton={copiedButton} onClick={() => handleCopy(JSON.stringify(fullJsonStructure, null, 2), 'full-json')} />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <CopyButton content={JSON.stringify(proventosData, null, 2)} buttonId="proventos-json" copiedButton={copiedButton} onClick={() => handleCopy(JSON.stringify(proventosData, null, 2), 'proventos-json')} />
                    </div>
                    ...
                    <div className="relative">
                        ...
                        <CopyButton content={JSON.stringify(descontosData, null, 2)} buttonId="descontos-json" copiedButton={copiedButton} onClick={() => handleCopy(JSON.stringify(descontosData, null, 2), 'descontos-json')} />
                    </div>
                </div>
