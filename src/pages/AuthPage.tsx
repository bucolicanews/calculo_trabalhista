    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-black text-white p-4">
      <div className="w-full max-w-md p-8 space-y-6 bg-gray-900 rounded-lg shadow-lg border border-orange-500">
        ...
        <Auth
          ...
          // Reativando Magic Link e desativando e-mail/senha
          providers={[]}
          onlyThirdPartyProviders={false}
          redirectTo={redirectToUrl} 
          view={initialView}
          magicLink={true} // Ativando Magic Link
          socialLayout="horizontal"
          // 2. Tradução completa para PT-BR (mantendo os links vazios conforme solicitado)
          localization={{
            variables: {
              sign_in: {
