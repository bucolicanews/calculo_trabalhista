...
const CalculationWebhookSender: React.FC<CalculationWebhookSenderProps> = ({
    ...
    const fetchAvailableWebhooks = async () => {
        ...
        const { data, error } = await supabase
            ...
            .select('*')
            // Esta cláusula OR é o filtro funcional (quais webhooks são relevantes para cálculos)
        ...
        if (error) {
            ...
            console.error('[CalculationWebhookSender] Erro ao buscar webhooks:', error);
            setAvailableWebhooks([]);
        } else {
            console.log('[CalculationWebhookSender] Webhooks carregados com sucesso:', data);
    ...
    const handleConfirmSend = async () => {
        console.log('[CalculationWebhookSender] Botão "Enviar Selecionados" clicado.');
