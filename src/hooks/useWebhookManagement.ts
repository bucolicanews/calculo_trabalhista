...
export const useWebhookManagement = () => {
    ...
    // Efeito para buscar webhooks ao montar o componente (sem filtro de usuário)
    useEffect(() => {
        fetchWebhooks();
    }, []);
    ...
    const fetchWebhooks = async () => {
        ...
        // A consulta é global, sem filtro de user_id
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const payload = {
            user_id: user.id, // Mantém a referência de quem criou/editou
